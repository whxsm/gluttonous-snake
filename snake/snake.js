    ...
    function drawtable()//画地图
    {
    	...
    	for(var k=0;k<snakeCount;k++)//画蛇的身体
			...
			//绘制食物	
    		ctx.fillStyle ="black";
	     ctx.fillRect(foodx,foody,15,15);//绘制被填充的矩形，x，y，w，h
	     ctx.fill();//开始填充
    }
    ...
    function addfood(){
	foodx = Math.floor(Math.random()*60)*15; //随机产生一个15-60之间的数
   ...
   function keydown(e){
   switch(e.keyCode){
         case 37: togo=1; break;//左（方向键）
		 case 38: togo=2; break;//上
		 case 39: togo=3; break;//右
		 case 40: togo=4; break;//下
         case 65: togo=1; break;//左，A
         case 87: togo=2; break;//上，W
         case 68: togo=3; break;//右,D
         case 83: togo=4; break;//下，W
